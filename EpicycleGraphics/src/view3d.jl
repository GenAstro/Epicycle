...
view = View3D(coord_sys=CoordinateSystem(moon, ICRF()))
...
"""
    View3D(; coord_sys::CoordinateSystem = CoordinateSystem(earth, ICRF()))
...
```
"""
function View3D(; coord_sys::CoordinateSystem = CoordinateSystem(earth, ICRF()))
